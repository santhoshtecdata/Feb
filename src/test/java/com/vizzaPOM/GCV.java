...
public class GCV {
	...
	private static  GCV gcv =null;

	public static GCV getgcv() {
		
			gcv=PageFactory.initElements(driverManager.getDriver(),GCV.class);
	...
	@FindBy(xpath="/html/body/div[3]/div[2]/div/mat-dialog-container/div/div[2]/mat-radio-group/mat-radio-button[1]/label/div[1]/div[1]")
